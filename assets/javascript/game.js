        ...
        function guessOne() {
          ...
          console.log(guess);
            ...
            console.log(answerArray);
                  ...
                  for (i=0, j=0; i < guess.length; i++, j++) {
                    if (count<30 && guessArray[j] !== guess) {
            ...
            console.log(guessArray);
                ...
                if (count <= 30) {
                document.getElementById("counter").innerHTML = "Number of Guesses Remaining: " + (30 - count);
                }
...
function refresh() {
    ...
    wins=0;
    guessArray = [];
    document.getElementById("counter").innerHTML = "Number of Guesses Remaining: 30";
